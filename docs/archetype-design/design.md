...
> - `tests/test_workflow_archetype.py`：49 项契约测试全过（含 P1-2 quality_router 条件边路由直测、P1-3 `_soul_injection_for_archetype` 纯函数开关组合、P1-4 narrative 边链逐条断言、P1-5 quality_node 闭包验证、BUG-029 fiction 回归）。
...
> - 专家团三视角评审（架构/测试/规则）首轮均分 7，修复 P0-1 + P1-2~5 后复评。
